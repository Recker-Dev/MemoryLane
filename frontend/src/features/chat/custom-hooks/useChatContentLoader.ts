    ...
    useEffect(() => {
        ...
        if (readyState !== WebSocket.OPEN) {
            (async () => {
                ...
                try {
                    ...
                    toast.error(`Unexpected error fetching chat history: ${error.message}`);
                    router.push(`/chat/${userId}`);
                }
                finally {
                    setTimeout(() => {
        ...
        (async () => {
            try {
                ...
                toast.error(`Unexpected error fetching chat memories.${error.message}`);
            }
        })();
        ...
        (async () => {
            try {
                ...
                const error = err as Error;
                toast.error(`Unexpected error fetching chat files.${error.message}`);
            }
